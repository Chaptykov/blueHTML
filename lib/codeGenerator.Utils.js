...
module.exports = {
  ...
  _getLookUpContextName: function (code_generation_context, node) {
    ...
    var inverted_index = node.value.length - 2;
    var context_index = (number_of_elements_to_exclude - inverted_index) < 0 ? 0 : number_of_elements_to_exclude - inverted_index;
    var selected_context_name = code_generation_context.contextStack[context_index] ? code_generation_context.contextStack[context_index].value : code_generation_context.currentContextName.value;
