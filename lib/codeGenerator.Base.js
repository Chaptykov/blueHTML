...
var HookContainer = require('./hookContainer');
...
module.exports = (function () {
  ...
  codeGenerator.prototype.generateCode = function (string_hx, options) {
    ...
    return adapter.accumulateFinalTagsResult(this.options, result);
  };
