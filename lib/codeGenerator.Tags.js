...
module.exports = {
  ...
  iterateOverTagNodes: function (nodes, code_generation_context, parent_require_new_context) {
    ...
    var handle_function;
    var result = '';
    var variableName = code_generation_context.variableName;

    var there_is_NO_handlebars = _.all(nodes, function (node) {
...
/// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  htmlBlockNode: function (code_generation_context) {
    ...
    var attributes_result = this.parseAttributes(code_generation_context);
    var children_result = this.iterateOverTagNodes(code_generation_context.astNode.children, code_generation_context, true);
    var adapter = code_generation_context.adapter;
    var virtual_dom = adapter.defineBlockTag(code_generation_context_clone, code_generation_context_clone.astNode.openTag, attributes_result, children_result);
  ...
  htmlSingleNode: function (code_generation_context) {
    ...
    var attributes_result = this.parseAttributes(code_generation_context);
    var adapter = code_generation_context.adapter;
    var virtual_dom = adapter.defineSingleTag(code_generation_context_clone, code_generation_context_clone.astNode.tag, attributes_result);
  ...
  text: function (code_generation_context) {
    ...
    var adapter = code_generation_context.adapter;
    var virtual_dom = adapter.defineTextTag(code_generation_context, '\'' + code_generation_context.astNode.value.replace(/'/g, "\\'") + '\'');
...
/// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  _concatenateTagValues: function (accumulator_variable_name, children_result, code_generation_context, are_children_array) {
    ...
    if (_.isFunction(adapter.concatenateTagValues)) {
      return adapter.concatenateTagValues(accumulator_variable_name, children_result, code_generation_context);
    }
...
/// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  handlebarsSAFEEVALUATION: function (code_generation_context) {
    ...
    var adapter = code_generation_context.adapter;
    var virtual_dom = adapter.defineTextTag(code_generation_context, '_.escape(' + code_generation_context.currentContextName.value + '.' + code_generation_context.astNode.value + ')');
  ...
  handlebarsUNSAFEEVALUATION: function (code_generation_context) {
    ...
    var adapter = code_generation_context.adapter;
    var virtual_dom = adapter.defineTextTag(code_generation_context, '""+' + code_generation_context.currentContextName.value + '.' + code_generation_context.astNode.value);
  ...
  handlebarsLOOKUPSINGLE: function (code_generation_context) {
    ...
    var virtual_dom = adapter.defineTextTag(code_generation_context, expression);
  ...
  handlebarsSAFEREFERENCEEVALUATION: function (code_generation_context) {
    ...
    if (code_generation_context.currentContextName[property_name]) {
      var adapter = code_generation_context.adapter;
      var expression = '_.escape(' + code_generation_context.currentContextName.contextName + '.' + property_name + ')';
      var virtual_dom = adapter.defineTextTag(code_generation_context, expression);
  ...
  handlebarsEACH: function (code_generation_context) {
    ...
    var accumulator_variable_name = this._generateUniqueId('eachAccumulator');
