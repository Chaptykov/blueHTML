...
module.exports = {
  ...
  runtimeGenericSingleHandle: function (code_generation_context) {
    ...
    var result = '(function(){var fn = ' + fn + '; return fn.call(this' + this._joinExternalFunctionParameters(code_generation_context.astNode.parameters, code_generation_context) + '); })()';
